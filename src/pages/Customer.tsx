...
export const Customer: React.FC = () => {
  ...
  const quotaModel = {
    designs: (isPaid || isTrial) ? 'Хязгааргүй' : '3 / 5',
    nesting: (isPaid || isTrial) ? 'Хязгааргүй' : '2 / 5',
    exports: isPaid ? 'Хязгааргүй' : (isTrial ? 'Хязгаарлагдсан (Туршилт)' : '0 / 1'),
  };
        ...
        <div className="lg:col-span-4 flex flex-col gap-6">
          <div className="bg-[#12141c] border border-white/5 rounded-2xl p-6 flex flex-col gap-5">
            ...
            <div className="flex flex-col gap-3 mt-2">
              <button
                onClick={() => handleOpenRenew('24 цагийн эрх (Сунгалт)', 5940)}
              ...
              >
                <div>
                  <div className="flex items-center gap-2">
                    ...
                    <span className="px-1.5 py-0.5 bg-red-500/10 text-red-500 border border-red-500/20 text-[8px] font-bold uppercase rounded">40% Хямдрал</span>
                  </div>
                  <span className="text-[10px] text-neutral-500">Бүх боломжууд нээлттэй</span>
                </div>
                <div className="flex flex-col text-right">
                  <span className="text-xs font-bold text-amber-500">5,940 ₮</span>
                  <span className="text-[9px] text-neutral-500 line-through font-medium">9,900 ₮</span>
                </div>
              </button>

              <button
                onClick={() => handleOpenRenew('1 сарын эрх (Сунгалт)', 17940)}
              ...
              >
                ...
                <div className="flex flex-col text-right">
                  <span className="text-xs font-bold text-amber-500">17,940 ₮</span>
